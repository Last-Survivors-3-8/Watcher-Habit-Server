const ERRORS = {
  ...
  INTERNAL_SERVER_ERROR: {
    STATUS_CODE: 500,
    MESSAGE:
      '죄송합니다. 서버에 문제가 발생했습니다. 잠시 후 다시 시도해주세요.',
  },
  INVALID_MONGO_ID: {
    STATUS_CODE: 400,
  ...
  SOCIAL_LOGIN_TYPE_REQUIRED: '소셜 로그인 타입은 필수입니다.',
  SOCIAL_LOGIN_TYPE_INCORRECT: '올바르지 않은 소셜 로그인 타입입니다.',
  INVALID_HABIT_START_DATE: '유효하지 않은 시작 날짜입니다.',
  INVALID_HABIT_END_DATE: '유효하지 않은 종료 날짜입니다.',
  INVALID_S3_URL: '는 유효한 S3 URL이 아닙니다.',
};
